...
\uncover<6->{b.f(1U);}\uncover<7->{         // call Base::f(int)}\end{codeblock}
  ...
  \uncover<10->{Virtual functions should specify exactly one of \code{virtual}, 
...
\begin{frame}{Where to go from here}
  ...
  \begin{itemize}
  \item C++ is a large and complex language and has a large and complex standard library
    \begin{itemize}
    \item Many more libraries are available from third parties
    \end{itemize}
  \item We have just scratched the surface of what the language and the libraries provide
