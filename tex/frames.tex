...
\uncover<3->{b \tikzref{aref}= a =\tikzref{eref}= b;}
\uncover<6->{bool b2 = a !\tikzref{neref}= 1234;}
\uncover<7->{bool b3 = b1 \alert<7>{\&\&} a < b;    // and
bool b4 = a < b \alert<7>{||} a < c; // or
bool b5 = \alert<7>{!}\alert<8>{(}a == b\alert<8>{)};      // not}}\end{codeblock}

  \item<8-> Note the use of parenthesis in \code{!(a == b)} to have the right
